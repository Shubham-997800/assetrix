...
export const KpiCard = memo(function KpiCard({ kpi, index }: { kpi: KpiItem; index: number }) {
  ...
  return (
    <div className="animate-fade-in-up" style={{ animationDelay: `${index * 50}ms` }}>
      <Link
        href={kpi.href}
        className="card-hover group block rounded-xl border border-border bg-card p-5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40"
      >
