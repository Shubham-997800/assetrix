...
function AssetStatusChart() {
  const statuses = [
    { label: "Available", value: 45, color: "var(--chart-3)" },
    { label: "Allocated", value: 32, color: "var(--primary)" },
    { label: "Under Maintenance", value: 12, color: "var(--chart-4)" },
    { label: "Reserved", value: 8, color: "var(--chart-2)" },
    { label: "Retired", value: 3, color: "var(--chart-5)" },
  ];
