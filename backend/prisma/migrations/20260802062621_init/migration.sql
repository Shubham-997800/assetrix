...
-- CreateIndex
CREATE INDEX "Asset_status_departmentId_idx" ON "Asset"("status", "departmentId");
...
-- CreateIndex
CREATE INDEX "Allocation_userId_status_idx" ON "Allocation"("userId", "status");
...
-- CreateIndex
CREATE INDEX "MaintenanceTask_status_assignedToId_idx" ON "MaintenanceTask"("status", "assignedToId");
