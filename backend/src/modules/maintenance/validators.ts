import { z } from "zod";
import { MAINTENANCE_STATUS, MAINTENANCE_TYPE } from "../../constants";
...
export const createMaintenanceTaskSchema = z.object({
  ...
  type: maintenanceTypeEnum.default(MAINTENANCE_TYPE.PREVENTIVE),
  priority: z
    .number()
    .int()
...
export const maintenanceTaskQuerySchema = z.object({
  ...
  requestedById: z.string().uuid("Invalid user ID").optional(),
